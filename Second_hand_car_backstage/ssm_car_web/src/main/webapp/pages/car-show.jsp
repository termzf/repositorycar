	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading">产品详细信息</div>
				<div class="row data-type">

					<div class="col-md-2 title">产品编号</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="订单编号"
							value="${car.carNum }" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								...
								value="${car.door_timeStr}">
						</div>
					</div>
					<div class="col-md-2 title">车型</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="路线名称"
							value="${car.car_series }" readonly="readonly">
					</div>

					<div class="col-md-2 title">排放标准</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="排放标准"
							value="${car.driving_type }" readonly="readonly">
					</div>

					<div class="col-md-2 title">燃油类型</div>
					<div class="col-md-4 data">
						<div class="input-group date">
							<div class="input-group-addon">
								<i class="fa fa-calendar"></i>
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="${car.fuel_type}"
								readonly="readonly">
						</div>
					</div>
			...
			<!--订单信息/--> <!--游客信息-->
			<div class="panel panel-default">
				<div class="panel-heading">有意购买人信息</div>
				<!--数据列表-->
				<table id="dataList"
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data text">${ car.user.address}</div>

					<div class="col-md-2 title">联系人</div>
					<div class="col-md-4 data text">${car.user.name}</div>

					<div class="col-md-2 title">手机号</div>
					<div class="col-md-4 data text">${car.user.tel}</div>

					<div class="col-md-2 title">邮箱</div>
					<div class="col-md-4 data text">${car.user.email}</div>
